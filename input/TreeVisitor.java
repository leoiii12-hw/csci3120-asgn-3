...
class TV {
  ...
  public int Start() {
    ...
    // Type Promotion
    double_1 = 1 * this.getInt();

    // Type Promotion
    double_1 = int_1 * int_1;

    // Check redeclartion assignment
    boolean_1 = this.getBoolean();

    // Assignement type error
    int_1 = 100.1;
    unknownIdentifier_1 = 1;
    ...
    boolean_1 = this.getInt() < this.getDouble() && this.getInt() < this.getDouble();
